...
public class DatabaseOperations {
    ...
    public List<String> listAllDatabases() {
        ...
        return HTTP.get(url, List.class, session.getUsername(), session.getPassword());
    ...
    public Information getSystemInformation() {
        ...
        return HTTP.get(url, Information.class, session.getUsername(), session.getPassword());
    ...
    private OperationResponse createOrDeleteDatabase(final String name, final String method) {
        ...
        if (method.equals(HttpPut.METHOD_NAME)) {
            ...
            return HTTP.put(url, OperationResponse.class, nullDocument, session.getUsername(), session.getPassword());
        } else {
