...
public class StatusOperationsTest {
    ...
    public void getWelcome() {
        final Welcome serverWelcome = new StatusOperations(new Session()).getWelcome();
    ...
    public void getUUIDS() {
        ...
        final int count = 3;
        final UUIDS uuids = new StatusOperations(new Session()).getUUIDS(count);
    ...
    public void getUUID() {
        ...
        final String uuid = new StatusOperations(new Session()).getUUID();
